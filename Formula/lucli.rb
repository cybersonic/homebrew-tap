class Lucli < Formula
  ...
  on_macos do
    url "https://github.com/cybersonic/LuCLI/releases/download/v#{version}/lucli-#{version}-macos"
    sha256 "3c1b41555cfe59ccd8fbd419d01aa7d6b0a96f7707fa421795ac231855048686"
  end

  on_linux do
    url "https://github.com/cybersonic/LuCLI/releases/download/v#{version}/lucli-#{version}-linux"
